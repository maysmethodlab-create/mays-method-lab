    ...
    <section className="section pt-16">
      ...
      <ScrollReveal>
        <div className="max-w-3xl mb-12">
          ...
          <div className="text-[12px] tracking-[0.18em] uppercase font-semibold text-maroon-muted mb-6">
            {tutorial.meta}
          </div>
      ...
      {tutorial.prerequisites.length > 0 ? (
        <ScrollReveal>
          <div className="dotted-frame bg-bg-subtle py-8 px-7 md:px-10 mb-12 max-w-3xl">
            <div className="eyebrow text-[11px] mb-3">Prerequisites</div>
            <ul className="list-disc pl-5 space-y-1 text-[15px] text-ink-secondary leading-relaxed">
      ...
      {related.length > 0 ? (
        <ScrollReveal>
          <div className="mt-20 pt-10 border-t border-line max-w-3xl">
            <div className="eyebrow text-[11px] mb-4">Related tutorials</div>
                ...
                <li key={r.slug}>
                  ...
                  >
                    <div className="flex items-center justify-between mb-2">
                      <span className="eyebrow text-[10px]">{r.category}</span>
      ...
      {tutorial.tags && tutorial.tags.length > 0 ? (
        <div className="mt-12 max-w-3xl">
          <div className="eyebrow text-[11px] mb-3">Tags</div>
          <div className="flex flex-wrap gap-2">
            {tutorial.tags.map((tag) => (
              <span
                key={tag}
                className="text-[11px] tracking-[0.05em] uppercase px-2 py-1 font-semibold border border-line text-maroon-muted bg-bg-subtle"
              >
                {tag}
              </span>
            ))}
