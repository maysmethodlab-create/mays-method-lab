...
const APP_ACADEMIC_CALENDAR_CHATBOT: LearningItem = {
  ...
  description:
    'Ask any question about registration windows, drop deadlines, finals weeks, breaks, or graduation. The chatbot returns the specific date with a citation back to the TAMU registrar.',
