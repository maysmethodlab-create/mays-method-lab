...
- **APT skill — calibration loop closed.** 10 baselines (Sean / Rich / Wendy across Lecturer, Senior Lecturer, Principal Lecturer, Clinical, Clinical Associate, Practice, Executive Professor) validated end-to-end against production. Voice fingerprints + per-subtype rules locked in. Style guide artifact: `docs/APT-style-guide.md`.
